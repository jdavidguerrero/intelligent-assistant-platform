		...
		"boxes": [
			{
				"box": {
					...
					"patching_rect": [20.0, 8.0, 300.0, 20.0],
					"numoutlets": 0,
					"numinlets": 1,
					"fontname": "Arial Bold",
					"fontsize": 13.0,
			...
			},
			{
				"box": {
					...
					"maxclass": "newobj",
					"text": "loadbang",
					"patching_rect": [20.0, 45.0, 75.0, 22.0],
					"numoutlets": 1,
					"outlettype": ["bang"],
					"numinlets": 0,
					"fontname": "Arial",
			...
			},
			{
				"box": {
					...
					"patching_rect": [140.0, 50.0, 130.0, 18.0],
					"numoutlets": 0,
					"numinlets": 1,
					"fontname": "Arial",
					"fontsize": 10.0,
			...
			},
			{
				"box": {
					...
					"maxclass": "newobj",
					"text": "delay 3000",
					"patching_rect": [20.0, 82.0, 90.0, 22.0],
					"numoutlets": 1,
					"outlettype": ["bang"],
					"numinlets": 2,
					"fontname": "Arial",
			...
			},
			{
				"box": {
					...
					"patching_rect": [20.0, 120.0, 240.0, 22.0],
					"numoutlets": 2,
					"outlettype": ["", ""],
					"numinlets": 2,
					"fontname": "Arial",
			...
			},
			{
				"box": {
					...
					"patching_rect": [20.0, 165.0, 160.0, 22.0],
					"numoutlets": 1,
					"outlettype": [""],
					"numinlets": 1,
					"fontname": "Arial",
			...
			},
			{
				"box": {
					...
					"maxclass": "newobj",
					"text": "print als-node",
					"patching_rect": [280.0, 120.0, 120.0, 22.0],
					"numoutlets": 0,
					"numinlets": 1,
					"fontname": "Arial",
					"fontsize": 12.0
			...
			},
			{
				"box": {
					...
					"patching_rect": [20.0, 235.0, 520.0, 22.0],
					"numoutlets": 0,
					"numinlets": 1,
					"fontname": "Arial",
					"fontsize": 10.0,
